...
# Experiments for training QNNs with data that is not linearly independent in H_x
# Setup:
# target unitary U randomly generated with 6 qubits
# training data randomly generated using data.sample_non_lihx_points
...
if __name__ == '__main__':
    ...
    for t in n_datapoints:
        ...
        print("Experiments with nlihx data")
        sys.stdout.flush()

        schmidt_ranks = [int(schmidt_rank)]
        writer_path = './experimental_results/nlihx_data/t' + str(t) + '/'
